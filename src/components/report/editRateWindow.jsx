...
import postRateReq from "../../data/salaryTable/postRate.ts";
import { useSelector } from 'react-redux';
import { selectAccessToken } from "../../store/thisUserReducer";

const EditRate = ({ user, onClose }) => {
    ...
    const [numberValue, setNumber] = useState(user.rate[0].value);
    ;
    ...
    const addRate = async () => {
        const UserData = await postRateReq({
