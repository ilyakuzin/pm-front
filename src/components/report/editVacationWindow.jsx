...
import postVacationReq from "../../data/salaryTable/postVacation.ts";
import putVacationReq from "../../data/salaryTable/putVacation.ts";
import { useSelector } from 'react-redux';
import { selectAccessToken } from "../../store/thisUserReducer";

const EditVacation = ({ user, onClose }) => {
    ...
    const [numberValue, setNumber] = useState(user.vacation.vacation);
    ;
    ...
    const addVacation = async () => {
        const UserData = await postVacationReq({
    ...
    const updateVacation = async () => {
        const UserData = await putVacationReq({
            value: Number(numberValue),
            date: date
        },user.vacation._id, token);
        console.log(UserData);
        if (!UserData.message) {
            onClose();
        } else {
