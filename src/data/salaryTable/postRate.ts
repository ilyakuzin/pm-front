...
const postRateReq=async (
    ...
    accessToken:string
        ...
        const newData={value:data.value,date:date1,userId:data.userId}
        console.log(accessToken);
    const userData=await fetch('http://62.173.140.183:5000/api/paysheet/rate/add/',{
        headers: new Headers({
